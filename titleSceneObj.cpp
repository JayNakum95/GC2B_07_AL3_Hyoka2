...
//TitleSceneObj::TitleSceneObj() {} // コンストラクタの定義

// Removed the duplicate destructor definition here

void TitleSceneObj::Initialize(KamataEngine::Model* model, KamataEngine::Camera* camera, const KamataEngine::Vector3& position) {
	model_ = model;                          // モデルを設定
